...
public:
    ...
    void setupUi(QMainWindow *Main)
    {
        ...
        btnVMXConfigSave = new QPushButton(widget_3);
        btnVMXConfigSave->setObjectName(QString::fromUtf8("btnVMXConfigSave"));
        btnVMXConfigSave->setGeometry(QRect(600, 30, 99, 38));
        ...
        btnNormalXConfigSave = new QPushButton(widget_4);
        btnNormalXConfigSave->setObjectName(QString::fromUtf8("btnNormalXConfigSave"));
        btnNormalXConfigSave->setGeometry(QRect(600, 30, 99, 38));
    ...
    void retranslateUi(QMainWindow *Main)
    {
        ...
        btnVmXConfigFind->setText(QCoreApplication::translate("Main", "Help Find", nullptr));
        btnVMXConfigSave->setText(QCoreApplication::translate("Main", "Save", nullptr));
        ...
        btnNormalXConfigSave->setText(QCoreApplication::translate("Main", "Save", nullptr));
